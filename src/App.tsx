      ...
      if (!snap.empty) {
        ...
        const merged = LOCATIONS.map(base => {
          ...
          return { 
            ...base, 
            ...remote,
            sceneImage: base.sceneImage ? (remote.sceneImage || base.sceneImage) : undefined
          };
        });
        setLocations(merged);
      }
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="w-full max-w-7xl px-0 md:px-8 mb-20">
                <div className="overflow-x-auto pb-8 mask-fade-edges md:mask-none">
                  <div 
                ...
                <div className="md:hidden text-center mt-4 opacity-40 flex items-center justify-center gap-2">
                  <div className="flex gap-1 animate-pulse">
                    <div className="w-1 h-1 bg-white rounded-full" />
                    <div className="w-1 h-1 bg-white rounded-full" />
                    <div className="w-1 h-1 bg-white rounded-full" />
                  </div>
                  <span className="text-[10px] uppercase tracking-widest">左右滑動探索宇宙</span>
                </div>
              </div>
            </div>
